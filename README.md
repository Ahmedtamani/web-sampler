...
🔗 **Démo en ligne** : [https://web-sampler-frontend.onrender.com](https://web-sampler-frontend.onrender.com)  
...
| **Abdelkader Marouane** | Backend Node.js/Express, Base de données MongoDB, Admin Panel Angular, Déploiement Render |
...
**Développé avec ❤️ par Tamani Ahmed & Abdelkader Marouane**
